...
# Link luaw
gcc -std=gnu99 -s -Wall -O2 -g0 -o lua_add console.o additions.o -lm -llua

# Link lua
gcc -std=gnu99 -s -Wall -O2 -g0 -o luaw_add consolew.o additions.o -lm -llua

# Compile everything release w/o additions
gcc -std=gnu99 -Wall -O2 -g0 -c console.c consolew.c

# Link luaw
gcc -std=gnu99 -s -Wall -O2 -g0 -o lua console.o -lm -llua

# Link lua
gcc -std=gnu99 -s -Wall -O2 -g0 -o luaw consolew.o -lm -llua
